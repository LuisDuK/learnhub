...
const aiSuggestions = [
  {
    ...
    suggestion:
      "Bạn nên tập trung ôn thêm môn Văn trong tuần tới để nâng điểm trung bình. Đặc biệt chú ý phần đọc hiểu và viết văn.",
    priority: "high",
  ...
  },
  {
    ...
    suggestion:
      "Bạn đang học rất tốt môn Toán! Hãy tiếp tục duy trì và thử thách bản thân với những bài toán khó hơn.",
    priority: "medium",
...
export default function Progress() {
  ...
  const overallAverage =
    detailedScores.reduce((acc, score) => acc + score.average, 0) /
              ...
              <ChartContainer config={chartConfig} className="h-[300px]">
                <BarChart data={subjectScores}>
                  ...
                  <XAxis
                    ...
                    tick={{ fontSize: 12 }}
                    tickFormatter={(value) => {
                      const subject = subjectScores.find(
                        (s) => s.subject === value,
                      );
          ...
          <Card className="border-accent/20 shadow-lg bg-gradient-to-br from-white to-accent/5">
            ...
            <CardContent className="space-y-4">
              {aiSuggestions.map((suggestion) => (
                <Alert
                  key={suggestion.id}
                  className={`${suggestion.color} border-l-4`}
                >
